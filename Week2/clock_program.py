...
class Clock:
    ...
    def __init__(self, hour, minute, second):
        ...
        """
        # 코드를 쓰세요
        self.hours = Counter(self.HOURS)
        self.minutes = Counter(self.MINUTES)
        self.seconds = Counter(self.SECONDS)
        
        self.hours.value = hour
        self.minutes.value = minute
        self.seconds.value = second
